...
public class UploadExample extends CustomComponent implements UploadExampleBundle {
    ...
    public UploadExample(String context){
        init(context);
    }
    ...
    void advanced(VerticalLayout layout) {
        ...
        class UploadBox extends CustomComponent
            ...
            public void uploadSucceeded(SucceededEvent event) {
                ...
                ///Saves file in Custom Folder....
                FileOutputStream fos = null;
                try {
                    fos = new FileOutputStream(filename);
                } catch (FileNotFoundException ex) {
                    Notification.show("File Not Found to Save...",Notification.Type.ERROR_MESSAGE);
                }
                try {
                    fos.write(os.toByteArray());
                    fos.close();
                } catch (IOException ex) {
                    Notification.show("File IO Error...");
                }
